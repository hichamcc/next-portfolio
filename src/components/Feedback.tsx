...
const Feedback = () => {
    ...
    {
        text: "Hicham did a great job turning the design into a functional website on a tight schedule. He proactively gave input and met my high standards in details and perfection.",
        img: upwork.src,
        client: "UpWork Client"
    },
    {
        text: "Hicham completed the job with 100% accuracy. He is one of the best js developers I have ever met. I will definately work with him in the near future",
        img: upwork.src,
        client: "UpWork Client"
    }]
                        ...
                        <div className="relative sm:p-6 p-1">
                            <figure className="relative z-10">
                                ...
                                <figcaption className="flex flex-col items-center gap-2 p-6 pt-0 text-sm text-customBlue">
                                    <span className="flex gap-1 text-gray-700" role="img" aria-label="Rating: 5 out of 5 stars">
                                        {[...Array(5)].map((_, i) => (
                                            <StarIcon key={i} aria-hidden="true" className="w-5 h-5" />
                                        ))}
                                    </span>
